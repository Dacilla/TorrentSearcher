export const I = {
  ...
  magnet: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
      <path d="M6 3v7a6 6 0 0 0 12 0V3"/><path d="M3 3h6v4H3z"/><path d="M15 3h6v4h-6z"/>
    </svg>
  ),
  download: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
  ...
  star: (
    <svg viewBox="0 0 24 24" fill="currentColor">
      <path d="m12 2 3.1 6.3 7 1-5 4.9 1.2 6.8L12 17.8 5.8 21l1.2-6.8-5-4.9 7-1z"/>
    </svg>
  ),
  dot: (
    <svg viewBox="0 0 24 24" fill="currentColor">
  ...
  tv: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
      <rect x="3" y="5" width="18" height="13" rx="2"/><path d="m8 21 4-3 4 3"/>
    </svg>
  ),
  film: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
  ...
  sliders: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
      ...
      <circle cx="16" cy="7" r="2"/><circle cx="10" cy="17" r="2"/><circle cx="12" cy="12" r="2"/>
    </svg>
  ),
  zap: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
  ...
  flame: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
      <path d="M12 2c2 4-2 5-2 9a4 4 0 0 0 8 0c0-3-2-4-3-7-3 3-7 2-6 8a6 6 0 0 0 12 0c0-6-6-10-9-10z"/>
    </svg>
  ),
  brand: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
...
export const RES_BG: Record<string, string> = {
  '2160p': '#7c5cff',
  '1080p': '#3b82f6',
  '720p':  '#14b8a6',
  '480p':  '#71717a',
...
export const SRC_CLR: Record<string, string> = {
  'Remux':  '#10b981',
  'BluRay': '#3b82f6',
  'WEB-DL': '#0ea5e9',
  'WEBRip': '#0ea5e9',
